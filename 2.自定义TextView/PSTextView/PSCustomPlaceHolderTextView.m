...
@interface PSCustomPlaceHolderTextView ()

@property (nonatomic,weak) UILabel *placehoderLabel;

@end

@implementation PSCustomPlaceHolderTextView
...
- (void)layoutSubviews {
    ...
    self.placehoderLabel.frame = CGRectMake(self.placeholderLeftMargin + 2, self.placeholderTopMargin - 40, self.frame.size.width - 2 * self.placeholderLeftMargin, LabelFrame.size.height);
}
